#############################################################################
# Makefile for building: Bountycoin-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: ?? ?? 7 22:21:34 2014
# Project:  Bountycoin-qt.pro
# Template: app
# Command: h:\Qt\4.8.5\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile Bountycoin-qt.pro
#############################################################################
...
Makefile: Bountycoin-qt.pro  ../Qt/4.8.5/mkspecs/default/qmake.conf ../Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile Bountycoin-qt.pro
